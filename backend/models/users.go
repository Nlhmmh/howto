...
type User struct {
	...
	AccountType   string      `boil:"account_type" json:"accountType" toml:"accountType" yaml:"accountType"`
	AccountStatus string      `boil:"account_status" json:"accountStatus" toml:"accountStatus" yaml:"accountStatus"`
...
var (
	userAllColumns            = []string{"id", "display_name", "name", "birth_date", "phone", "email", "password", "is_admin", "account_type", "account_status", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"display_name", "name", "birth_date", "phone", "email", "password", "deleted_at"}
	userColumnsWithDefault    = []string{"id", "is_admin", "account_type", "account_status", "created_at", "updated_at"}
...
func (o *User) Contents(mods ...qm.QueryMod) contentQuery {
	...
	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`contents`.*"})
	}
